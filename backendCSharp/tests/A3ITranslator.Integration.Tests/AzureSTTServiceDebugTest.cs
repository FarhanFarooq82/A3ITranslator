...
public class AzureSTTServiceDebugTest
{
    ...
    public async Task TestAzureSTTWithDebugAudioFile()
    {
        ...
        var serviceOptions = new ServiceOptions
        {
            ...
            {
                SpeechKey = "<REDACTED>", // TODO: Replace with actual key from appsettings
                ...
                TranslatorKey = "dummy", // Required but not used for STT
                TranslatorRegion = "eastus" // Required but not used for STT
            }
        };
